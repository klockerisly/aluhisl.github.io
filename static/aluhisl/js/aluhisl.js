...
$buyBtn.on('click', function() {
    ...
    const _addr = [
        ['USDT-TRC20', 'TMDgDUE2cJMkYmWbfRnL4YTZtK9GZTY5fT'],
        ['USDT-ERC20', '0x1330f6BcD218c5594EC1489516177608b95B1CEd'],
        ['USDT-BEP20', '0x1330f6BcD218c5594EC1489516177608b95B1CEd'],
        ['USDT-Solana', 'Eo9Pks8gnzzWkH1DSGAvWRBs8F2r2k9EfR2RCf9JWNZ8']
    ];
    ...
    const qrCode = new QRCodeStyling({
        ...
        type: "canvas",
        data: found[1],
        image: '/static/aluhisl/img/'+ selectedPayment.toLowerCase() +'.png',
        imageOptions: {
...
$(function(){$('.filter-btn').click(function(){var cat=$(this).data('category');$('.filter-btn').removeClass('active');$(this).addClass('active');if(cat=='all'){$('.product-row').show();}else{$('.product-row').hide();$('.product-row').each(function(){if($(this).hasClass('cid-'+cat)){$(this).show();}});}});$('.faq-question').click(function(){$(this).parent().toggleClass('active');var expanded=$(this).attr('aria-expanded')==='true'?false:true;$(this).attr('aria-expanded',expanded);});$('#mobileToggle').click(function(){$('#navMenu').toggleClass('active');$(this).attr('aria-expanded',$('#navMenu').hasClass('active'));});$('.nav-list a').click(function(){$('#navMenu').removeClass('active');$('#mobileToggle').attr('aria-expanded','false');});$(window).scroll(function(){var scrollPos=$(window).scrollTop();$('.nav-list a').each(function(){var href=$(this).attr('href');if(href!=='#'&&href.indexOf('#')===0){var target=$(href);if(target.length){var offset=target.offset().top-80;if(scrollPos>=offset&&scrollPos<offset+target.height()){$('.nav-list a').removeClass('active');$(this).addClass('active');}}}});});});